...
class NN_Diagnostics():
    ...
    def summary(self):
        ...
        for ens in range(0,self.ndef.n_ensembles):
            ...
            home = str(Path.home())
            dir = self.ndef.basedir+'/'+self.ndef.field+'/'+self.ndef.exp+ '/' + self.ndef.set + '/en'+str(ens)
        ...
        np.save(self.ndef.basedir+'/'+self.ndef.field+'/'+self.ndef.exp+'/' + self.ndef.set+'/cor_t_end.npy',cor_t_end)
        np.save(self.ndef.basedir+'/'+self.ndef.field+'/'+self.ndef.exp+'/' + self.ndef.set+'/cor_v_end.npy',cor_v_end)
        np.save(self.ndef.basedir+'/'+self.ndef.field+'/'+self.ndef.exp+'/' + self.ndef.set+'/cor_i_end.npy',cor_v_end)
        np.save(self.ndef.basedir+'/'+self.ndef.field+'/'+self.ndef.exp+'/' + self.ndef.set+'/cor_t_best.npy',cor_t_best)
        np.save(self.ndef.basedir+'/'+self.ndef.field+'/'+self.ndef.exp+'/' + self.ndef.set+'/cor_v_best.npy',cor_v_best)
        np.save(self.ndef.basedir+'/'+self.ndef.field+'/'+self.ndef.exp+'/' + self.ndef.set+'/cor_i_best.npy',cor_i_best)

        f = open(self.ndef.basedir+'/'+self.ndef.field+'/'+self.ndef.exp+'/' + self.ndef.set+'/summary.txt', 'w')
        f.write('BEST \n')
        for ens in range(0,self.ndef.n_ensembles):
    ...
    def plot_history(self):
        ...
        fig.savefig(self.ndef.basedir+'/'+self.ndef.field+'/'+self.ndef.exp+ '/' + self.ndef.set+'/loss.png')
        fig.clear()
        plt.close('all')
    ...
    def plot_scatter(self,type='best',nens_cor=None, nens_epoch=None):
        ...
        for ens in range(0,self.ndef.n_ensembles):
            ...
            fig.savefig(self.ndef.basedir+'/'+self.ndef.field+'/'+self.ndef.exp+ '/' + self.ndef.set+'/scat_en'+str(ens)+'_'+type+'.png')
            fig.clear()
        ...
        dir = self.ndef.basedir+'/'+self.ndef.field+'/'+self.ndef.exp+ '/' + self.ndef.set
        ...
        fig.savefig(self.ndef.basedir+'/'+self.ndef.field+'/'+self.ndef.exp+ '/' + self.ndef.set+'/scat_en_mean_'+type+'.png')
        fig.clear()
        ...
        fig.savefig(self.ndef.basedir+'/'+self.ndef.field+'/'+self.ndef.exp+ '/' + self.ndef.set+'/scat_en_cor_'+str(nens_cor)+'_'+type+'.png')
        fig.clear()
        plt.close('all')
        ...
        fig.savefig(self.ndef.basedir+'/'+self.ndef.field+'/'+self.ndef.exp+ '/' + self.ndef.set+'/scat_en_epochs_'+str(nens_epoch)+'_'+type+'.png')
        fig.clear()
        plt.close('all')
    ...
    def plot_scatter_all(self,type='best'):
        ...
        fig.savefig(self.ndef.basedir+'/'+self.ndef.field+'/'+self.ndef.exp+ '/' + self.ndef.set+'/scat_all_'+type+'.png')
        fig.clear()
        plt.close('all')
    ...
    def plot_scatter_max(self,type='best'):
        ...
        fig.savefig(self.ndef.basedir+'/'+self.ndef.field+'/'+self.ndef.exp+ '/' + self.ndef.set+'/scat_max_'+type+'.png')
        fig.clear()
        plt.close('all')
